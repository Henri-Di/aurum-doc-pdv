...
<head>
    ...
    <title>Aurum | Novo Vendedor</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
            <button onclick="window.location.href='../clientes/view-new-cliente-aurum-doc-pdv.php';" id="btn-pessoa-juridica-bg-color-aurum"><i class="fa fa-user" aria-hidden="true"></i> Pessoa Fisica</button>
                <form>
                    <!-- Título da Seção do Formulário -->
                    <h3><i class="fa fa-user" aria-hidden="true"></i> Vendedor</h3>
                    ...
                    <div>
                        ...
                        <input type="text" id="comissao" name="comissao" placeholder="Comissão" autocomplete="off"/>
                    </div>
